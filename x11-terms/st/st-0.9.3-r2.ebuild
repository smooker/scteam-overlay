...
# SC Team patches:
#   02: fix-delete-keysym — Delete key sends \\033[3~ in default cursor mode
#       (vanilla st 0.9.3 sends DCH/EL/mouse escapes — wrong for keyboard)
...
PATCHES=(
	...
	"${FILESDIR}/02-fix-delete-keysym.patch"
